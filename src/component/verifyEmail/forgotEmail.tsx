            ...
            >
                ...
                >
                    ...
                    <CardContent sx={{ textAlign: 'center' }}>
                        {/* Icon and Title */}
                        <Box sx={{ mb: 2 }}>
                            <Lock sx={{ fontSize: 40, color: 'primary.main' }} /> {/* Use theme's primary color */}
                            <Typography
                        ...
                        >
                            Seem like you forgot your password account. If this is true, click below to reset your password.
                        </Typography>
